const Footer = () => {
  return (
    <div className="absolute bottom-0 px-2 left-0 flex justify-between bg-[#24292E] text-[9px] sm:text-[11px] text-white w-full">
      ...
      <div className="flex gap-1 items-center">
        <div className="flex gap-2 items-center hover:bg-[#4f4f52] cursor-pointer p-1">
          ...
          <p className="whitespace-nowrap">Powered by Next.js</p>
        </div>
        <div className="flex gap-2 items-center hover:bg-[#4f4f52] cursor-pointer p-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
