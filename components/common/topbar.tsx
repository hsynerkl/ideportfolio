...
const Topbar = () => {
  ...
  return (
    <div className="w-full h-fit bg-[#1f2428] text-white text-[13px] flex">
      <ul className="flex text-xs font-medium">
        <li>
          <Link
            href="/home"
            className={`flex gap-2 items-center hover:bg-[#24292e] px-4 py-2 ${
              (pathname === "/" || "/home") && "bg-[#24292e]"
            }`}
          >
            <svg
